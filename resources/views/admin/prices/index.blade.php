    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ route('admin.prices.create') }}">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Sub-Description</th>
                    ...
                    @forelse ($prices as $price)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('assets/images/prices/' . $price->img) }}" alt="iMac Front Image"
                                    class="h-10 aspect-video object-cover mr-3">
                            </th>
                            <x-table-data value="{{ $price->url }}" />
                            <x-table-data value="{{ $price->title }}" />
                            <x-table-data>
                                {!! $price->description !!}
                            </x-table-data>
                            <x-table-data value="{{ $price->sub_title }}" />
                            <x-table-data value="{{ $price->sub_description }}" />
                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">
                                    ...
                                    <x-delete-confirm-button identifier="{{ $price->id }}" {{-- {{url('admin/links/'.$link->id.'/delete')}} --}}
                                        deleteUrl="{{ route('admin.prices.destroy', $price->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $price->id }}"
                                        editUrl="{{ route('admin.prices.edit', $price->id) }}" tooltipText="Edit item" />
                                </div>
                            </td>
                        </tr>
                    @empty
