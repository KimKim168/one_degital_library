...
@section('content')
    <div class="p-4">
        ...
        <form class="w-full" action="{{ route('admin.prices.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="sub_title" class="block mt-1 w-full" type="text" name="sub_title" :value="old('sub_title')"
                        required autofocus placeholder="sub_title" />
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div>
                    ...
                    {{-- <x-text-input id="description" class="block mt-1 w-full" type="text" name="description"
                        :value="old('description')" required autofocus placeholder="description" />
                ...
                <div>
                    ...
                    <x-text-input id="sub_description" class="block mt-1 w-full" type="text" name="sub_description"
                        :value="old('sub_description')" required autofocus placeholder="Sub-Description" />
