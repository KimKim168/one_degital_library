    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ route('admin.academies.create') }}">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Video Image</th>
                        <th scope="col" class="px-4 py-3">Video Link</th>
                    ...
                    @forelse ($academy as $academy)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('assets/images/academies/' . $academy->image) }}"
                                    alt="iMac Front Image" class="h-10 aspect-video object-cover mr-3">
                            </th>
                            <x-table-data value="{{ $academy->url }}" taget="_blant" />
                            <x-table-data value="{{ $academy->video_title }}" />
                            <x-table-data>
                                {!! $academy->description !!}
                            </x-table-data>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">
                                    ...
                                    <x-view-detail-button identifier="" viewDetailUrl=""
                                        tooltipText=" View item details" />
                                    <x-delete-confirm-button identifier="{{ $academy->id }}" {{-- {{url('admin/links/'.$link->id.'/delete')}} --}}
                                        deleteUrl="{{ route('admin.academies.destroy', $academy->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $academy->id }}"
                                        editUrl="{{ route('admin.academies.edit', $academy->id) }}"
