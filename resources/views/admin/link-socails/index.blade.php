    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ url('/admin/links/create') }} ">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Link Name</th>
                    ...
                    @forelse ($links as $link)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row "
                                ...
                                <img src="{{ asset('/assets/images/links/' . $link->logo_image) }}" alt="iMac Front Image"
                                    class="h-10 aspect-video object-cover mr-3 h-10 w-10">
                            </th>

                            <x-table-data value="{{ $link->name }}" />
                            <x-table-data value="{{ $link->url }}" />

                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">

                                    <x-view-detail-button identifier="" viewDetailUrl="#" {{-- {{ route('admin.slides.show', $slide->id) }} --}}
                                        tooltipText=" View item details" />
                                    <x-delete-confirm-button identifier="{{ $link->id }}" {{-- {{url('admin/links/'.$link->id.'/delete')}} --}}
                                        deleteUrl="{{ route('admin.links.delete', $link->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $link->id }}"
                                        editUrl="{{ route('admin.links.edit', $link->id) }}" tooltipText="Edit item" />
                                </div>
                            </td>
                        </tr>
                    @empty
