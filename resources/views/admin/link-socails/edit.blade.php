...
@section('content')
    <div class="p-4">
        ...
        <form class="w-full" action="{{ route('admin.links.update', $links->id) }}" method="Post"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                        value="{{ $links->name }}" required autofocus placeholder="Name" />
                ...
                <div>
                    ...
                    <x-text-input id="url" class="block mt-1 w-full" type="text" name="url"
                        value="{{ $links->url }}" required autofocus placeholder="url" />
            ...
            <div class="my-5">
                <div class="flex items-center space-4">
                    <div class="max-w-40 ">
                        <img id="selected-image" src="{{ asset('/assets/images/links/' . $links->logo_image) }}"
