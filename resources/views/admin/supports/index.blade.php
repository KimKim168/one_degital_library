    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ url('/admin/supports/create') }} ">
                ...
                <tbody>
                    @forelse ($support as $support)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <x-table-data value="{{ $support->title }}" />
                            <x-table-data>
                                {!! $support->description !!}
                            </x-table-data>
                            <x-table-data value="{{ $support->url }}" />
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">
                                    ...
                                    <x-delete-confirm-button identifier="{{ $support->id }}"
                                        deleteUrl="{{ route('admin.supports.destroy', $support->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $support->id }}"
                                        editUrl="{{ route('admin.supports.edit', $support->id) }}"
