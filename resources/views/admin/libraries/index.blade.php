    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ route('admin.libraries.create') }}">
                    ...
                    @forelse ($libraries as $library)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('assets/images/libraries/' . $library->image) }}"
                                    alt="iMac Front Image" class="h-10 aspect-video object-cover mr-3">
                            </th>
                            <x-table-data value="{{ $library->name }}" />


                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">

                                    <x-view-detail-button identifier="{{ $library->id }} " viewDetailUrl="#"
                                        {{-- {{ route('admin.slides.show', $slide->id) }} --}} tooltipText=" View item details" />
                                    <x-delete-confirm-button identifier="#"
                                        deleteUrl="{{ url('/admin/libraries/' . $library->id . '/delete') }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier=""
                                        editUrl="{{ url('/admin/libraries/' . $library->id . '/edit') }}"
