...
@section('content')
    <div class="p-4">
        ...
        <form class="w-full" action="{{ url('/admin/libraries/' . $library->id) }}" method="POST"
            ...
            <div class="grid md:grid-cols-1 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                        value="{{ $library->name }}" required autofocus placeholder="Name" />
            ...
            <div class="my-5">
                <div class="flex items-center space-4">
                    <div class="max-w-40">
                        <img id="selected-image" src="{{ asset('assets/images/libraries/' . $library->image) }}"
