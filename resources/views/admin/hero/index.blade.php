    ...
    <div>
        ...
        <div
            ...
            <div
                ...
                <x-primary-button href="{{ url('/admin/hero/1/edit') }} ">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3">Button Title</th>
                    ...
                    @forelse ($hero as $hero)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('assets/images/hero/' . $hero->image) }}" alt="iMac Front Image"
                                    class="h-10 aspect-video object-cover mr-3">
                            </th>
                            <x-table-data value="{{ $hero->title }}" />
                            <x-table-data value="{{ $hero->description }}" />
                            <x-table-data value="{{ $hero->placeholder }}" />
                            <x-table-data value="{{ $hero->bottun_title }}" />
                        </tr>
                    @empty
                        <tr>
