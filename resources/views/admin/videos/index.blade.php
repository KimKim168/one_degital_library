                    ...
                    @forelse ($videos as $video)
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <th scope="row"
                                ...
                                <img src="{{ asset('assets/images/videos/' . $video->image) }}" alt="iMac Front Image"
                                    class="h-10 aspect-video object-cover mr-3">
                            </th>
                            <x-table-data value="{{ $video->url }}" taget="_blant" />
                            <x-table-data value="{{ $video->video_title }}" />
                            <x-table-data>
                                {!! $video->description !!}
                            </x-table-data>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start gap-3 justify-center">
                                    ...
                                    <x-delete-confirm-button identifier="{{ $video->id }}" {{-- {{url('admin/links/'.$link->id.'/delete')}} --}}
                                    ...
                                    <x-edit-button identifier="{{ $video->id }}"
                                        editUrl="{{ route('admin.videos.edit', $video->id) }}" tooltipText="Edit item" />
                                </div>
                            </td>
                        </tr>
                    @empty
