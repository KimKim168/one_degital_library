...
@section('content')
    <div class="p-4">
        ...
        <form class="w-full" action="{{ route('admin.videos.update', $videos->id) }}" method="POST"
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="video_title" class="block mt-1 w-full" type="text" name="video_title"
                        value="{{ $videos->video_title }}" required autofocus placeholder="Title" />
                ...
                <div>
                    ...
                    <x-text-input id="url" class="block mt-1 w-full" type="text" name="url"
                        value="{{ $videos->url }}" required autofocus placeholder="url" />
            ...
            <div class="my-5">
                <div class="flex items-center space-4">
                    <div class="max-w-40">
                        <img id="selected-image" src="{{ asset('assets/images/videos/' . $videos->image) }}"
