...
<body class="min-h-[100vh] font-body">
    <div class="antialiased min-h-[100vh] bg-gray-50 dark:bg-gray-800">
            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="/" class="flex items-center justify-center mr-4">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">POS
                            Potato</span>
                    </a>
        ...
        <aside
            ...
            <a href="/" class="flex items-center justify-center mt-4">
                <img src="{{ asset('assets/client/images/logo - Copy/DGLogo.png') }}" class="mr-3 h-8"
                    alt="Flowbite Logo" />
            ...
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <x-sidebar-item href="{{ route('admin.slides.index') }}" class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li>
                        <x-sidebar-item href="{{ route('admin.features.index') }}" class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-list">
                                <rect width="7" height="7" x="3" y="3" rx="1" />
                    ...
                    <li>
                        ...
                        <x-sidebar-item href="{{ route('admin.libraries.index') }}"
                            class="{{ request()->is('admin/libraries*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                                stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-text">
                                <path
                                    d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20" />
                                <path d="M8 11h8" />
                                <path d="M8 7h6" />
                            </svg>
                            <span class="ml-3">Libraries</span>
                        </x-sidebar-item>
                    </li>
                    <li>
                        <x-sidebar-item href="{{ route('admin.hero.edit') }}"
                            class="{{ request()->is('admin/hero*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <x-sidebar-item href="{{ route('admin.links.index') }}"
                            class="{{ request()->is('admin/links*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                            ...
                            <span class="ml-3">Link Socail Media</span>
                        </x-sidebar-item>
                    </li>
                    <li>
                        <x-sidebar-item href="{{ route('admin.prices.index') }}"
                            class="{{ request()->is('admin/prices*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                    ...
                    <li>
                        <x-sidebar-item href="{{ route('admin.academies.index') }}"
                            class="{{ request()->is('admin/academies*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                    ...
                    <li>
                        <x-sidebar-item href="{{ route('admin.supports.index') }}"
                            class="{{ request()->is('admin/academies*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25"
                                stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-headset">
                                <path
                                    d="M3 11h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5Zm0 0a9 9 0 1 1 18 0m0 0v5a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3Z" />
                                <path d="M21 16v2a4 4 0 0 1-4 4h-5" />
                            </svg>
                            <span class="ml-3">Supports</span>
                        </x-sidebar-item>
                    </li>
                    <li>
            ...
            <div class="absolute bottom-0 justify-center p-2 space-x-4 w-full flex bg-white dark:bg-gray-800 z-20">
                <button id="theme-toggle" type="button"
                    class="text-gray-600 hover:text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2">
        ...
        <main class="p-4 md:ml-64 h-auto pt-20 dark:bg-gray-800">
    ...
    <script>
        ...
        var areas = ['details', 'description', 'description_kh'];
